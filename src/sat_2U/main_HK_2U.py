...
import src.settings_init.HK.physical_parameters_HK as phy_HK
#------------------------------------------------------
# main

def analysis_HK_2U(item):
    ...
    HK_data = bc.BAT_calc_result(HK_data, phy_HK.battery_resistance_2U)
